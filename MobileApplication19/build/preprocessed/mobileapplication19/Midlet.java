    ...
    class PadajacySnieg extends Canvas {
        ...
        protected void paint(Graphics g) {
            ...
            for (int y = 0; y < height; ++y) {
                ...
                //jeśli jest nad pokrywą
                if (y < height - 1 - pokrywa[x]) {
                    g.drawLine(x, y, x, y); // symulacja płatka
                } else if (y == height - 1 - pokrywa[x]) { // jeśli jest na pokrywie 
                    pokrywa[x]++; // zwiększa się wysokość pokrywy
                }

            }
            // od lewej do prawej po pokrywie
            for (int i = 0; i < width; i++) {
